...
int main(int argc, char* argv[]) {
	...
	while (true) {
		...
		pthread_create(&filethread, NULL, handlerequest, new UDTSOCKET(fhandle));
		pthread_detach(filethread);
#else
		CreateThread(NULL, 0, handlerequest, new UDTSOCKET(fhandle), 0, NULL);
#endif
	}
...
#ifndef WIN32
void* handlerequest(void* usocket)
#else
DWORD WINAPI handlerequest(LPVOID usocket)
#endif
{
